...
console.log('Categoría:       Servicio de envío de remesas internacionales');

// TODO: Indica el estado actual de la entidad (string)
// Ejemplos: 'Disponible', 'En stock', 'Activo', 'Ocupado'
console.log('Estado:          Servicio activo');
...
// Ejemplo en remesas: monto de dinero enviado
console.log('Monto de remesa enviada (USD):    500');

// TODO: Reemplaza el 0 por una expresión aritmética que se calcule automáticamente
// Ejemplo en remesas: monto recibido después de una comisión del 5%
console.log('Monto recibido después de comisión:    ', 500 - (500 * 0.05));

// TODO: Valor boolean que representa un estado de la entidad (true o false — sin comillas)
// Ejemplo: la remesa fue procesada correctamente
console.log('Remesa procesada:  true');

// TODO: Otro valor boolean diferente al anterior (true o false — sin comillas)
// Ejemplo: la remesa no fue cancelada
console.log('Remesa cancelada:  false');
...
console.log('Total registros:  250');
...
console.log('  TransWorld facilita el envío seguro de remesas internacionales.');
